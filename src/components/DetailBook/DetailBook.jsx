...
import RateNComment from "../RateNComment/RateNComment";
import SubmitRateNComment from "../SubmitRateNComment/SubmitRateNComment";
    ...
    const fetchBookDetail = async () => {
      try {
        const response = await axios.get(
          "/posts/" + JSON.parse(localStorage.getItem("IDbook"))
        );
      ...
      <div className="row">
        <div className="col-md-9 align-self-start small px-0">
          ...
          <div className="border-bottom pb-2">
            <h5 className="fw-bold mb-0">abc</h5>
            ...
            <div className="col-md-9 px-0">
              ...
              <div className="isbn-edition my-0 d-flex text-center">
                ...
                <a href="" className="link-dark">
                  <p className="font-weight-normal">
                    Xem tất cả bản sao của ấn bản ISBN này:
                  </p>
                </a>
              </div>
              <div className="new-used d-flex">
                <div className="new d-flex flex-column rounded-2 bg-light shadow mr-2 col-3 p-2">
                  <a href="" className="link-dark">
                    <div className="link-info">45 Cuốn mới</div>
                    từ
                    <span className="link-danger"> US$ 14.44</span>
                  </a>
                </div>
                <div className="new d-flex flex-column rounded-2 bg-light shadow mr-2 col-3 p-2">
                  <a href="" className="link-dark">
                    <div className="link-info">45 Cuốn cũ</div>
                    từ
                    <span className="link-danger"> US$ 5.26</span>
                  </a>
                </div>
              </div>
              <div className="d-flex mt-4 border-bottom">
                <div className="d-block col-6 px-0">
                  <div className="isbn-edition my-0 d-flex text-center">
                    ...
                    <a href="" className="link-dark">
                      <p className="font-weight-normal">
                        Xem tất cả định dạng và ấn bản của tiêu đề:
                      </p>
                    </a>
                  </div>
                ...
                <div className="d-block col-6 px-0">
                  <div className="isbn-edition my-0 d-flex text-center">
                    ...
                    <a href="" className="link-dark">
                      <p className="font-weight-normal">
                        Xem tất cả các phiên bản của tiêu đề:
                      </p>
                    </a>
                  </div>
                  <div className="new-used d-flex mx-0 px-0 justify-content-evenly">
                    <div className="new d-flex flex-column rounded-5 bg-light shadow p-2 mb-3 col-5">
                      ...
                      >
                        <div>
                          <small>Ấn bản đầu tiên (527)</small>
                        </div>
                        <div>
            ...
            <div className="border-top mt-5">
              <div className="row">
                ...
                <div className="col-md-8">
                  <div className="mt-4">
                    <h5 className="font-weight-bold">abc</h5>
                    <p>Tác giả: abc</p>
                    <p>Mô tả về sách... abc</p>
                    <p>Thể loại: abc</p>
                    <p>Ngày xuất bản: abc</p>
              ...
              <div className="row">
                <div className="col-md-4">
                  <div className="mt-4">
                    ...
                    <p>
                      <small>được chấp nhận bởi bên bán</small>
                    </p>
                  </div>
                </div>
                <div className="col-md-8">
