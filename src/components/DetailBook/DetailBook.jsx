            ...
            <div className="row">
                <div className="col-md-9 align-self-start small px-0">
                    ...
                    <div className="border-bottom pb-2">
                        <h5 className="fw-bold mb-0">The Shards: A novel</h5>
                        ...
                        <div className="d-flex align-items-center mt-2">
                            ...
                            <span className="me-2 ml-2 mr-0">4.01 đánh giá trung bình</span>
                            <span className="me-2 mr-0">•</span>
                            <span className="me-2">4,246 đánh giá bởi Goodreads</span>
                        </div>
                    </div>
                    <div className="row pt-3 mx-0">
                        ...
                        <div className="col-md-9 px-0">
                            <div className="book-conver-type">
                                <h5 className="font-weight-normal my-0"><span>Bản cứng</span></h5>
                            </div>
                            <div className="isbn">
                            ...
                            <div className="publisher my-0">
                                <p className="font-weight-normal mt-0"><span>Nhà xuất bản: Knopf, 2023</span>
                                </p>
                            </div>
                            <div className="isbn-edition my-0 d-flex text-center">
                                <p><i className='fas fa-greater-than'></i></p>
                                <a href="" className="link-dark">
                                    <p className="font-weight-normal">Xem tất cả bản sao của ấn bản ISBN này:</p>
                                </a>
                            </div>
                            <div className="new-used d-flex">
                                <div className="new d-flex flex-column rounded-2 bg-light shadow mr-2 col-3 p-2">
                                    <a href="" className="link-dark">
                                        <div className="link-info">45 Cuốn mới</div>từ<span className="link-danger"> US$
                                            14.44</span>
                                    </a>
                                </div>
                                <div className="new d-flex flex-column rounded-2 bg-light shadow mr-2 col-3 p-2">
                                    <a href="" className="link-dark">
                                        <div className="link-info">45 Cuốn cũ</div>từ<span className="link-danger"> US$
                                            5.26</span>
                                    </a>
                                </div>
                            </div>
                            <div className="d-flex mt-4 border-bottom">
                                <div className="d-block col-6 px-0">
                                    <div className="isbn-edition my-0 d-flex text-center">
                                        <p><i className='fas fa-greater-than'></i></p>
                                        <a href="" className="link-dark">
                                            <p className="font-weight-normal">Xem tất cả định dạng và ấn bản của tiêu đề:</p>
                                        </a>
                                    </div>
                                    <div className="new-used d-flex mx-0 px-0 justify-content-evenly">
                                        <div className="new d-flex flex-column rounded-5 bg-light shadow p-2 col-5">
                                            <a href="" className="link-dark text-decoration-none text-center">
                                                <div>Bản mềm (527)</div>
                                                từ <span className="link-danger"> US$ 14.44 </span>
                                            </a>
                                        </div>
                                        <div className="new d-flex flex-column rounded-5 bg-light shadow p-2 col-5">
                                            <a href="" className="link-dark text-decoration-none text-center">
                                ...
                                <div className="d-block col-6 px-0">
                                    <div className="isbn-edition my-0 d-flex text-center">
                                        <p><i className='fas fa-greater-than'></i></p>
                                        <a href="" className="link-dark">
                                            <p className="font-weight-normal">Xem tất cả các phiên bản của tiêu đề:</p>
                                        </a>
                                    </div>
                                    <div className="new-used d-flex mx-0 px-0 justify-content-evenly">
                                        <div className="new d-flex flex-column rounded-5 bg-light shadow p-2 mb-3 col-5">
                                            <a href="" className="link-dark text-decoration-none text-center">
                                                <div><small>Ấn bản đầu tiên (527)</small></div>
                                                <div><small>Xem ưu đãi</small></div>
                                            </a>
                                        </div>
                                        <div className=" new d-flex flex-column rounded-5 bg-light shadow p-2 mb-3 col-5">
                                            <a href="" className="link-dark text-decoration-none text-center">
                                                <div><small>Bản sao đã ký (527)</small></div>
                                                <div><small>Xem ưu đãi</small></div>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div className="border-top mt-5">
                            <div className="row">
                                <div className="col-md-4">
                                    <div className="mt-4">
                                        <h4 className="font-weight-bold">Giới thiệu về cuốn sách</h4>
                                    </div>
                                </div>
                                <div className="col-md-8">
                                    <div className="mt-4">
                                        <h5 className="font-weight-bold">Sample Book</h5>
                                        ...
                                        <p>Đánh giá: 4.5</p>
                                        <p>Giải thưởng: Best Book of the Year</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border-top mt-5">
                            <div className="row">
                                <div className="col-md-4">
                                    <div className="mt-4">
                                        <h4 className="font-weight-bold">Phương thức thanh toán</h4>
                                        <p><small>được chấp nhận bởi bên bán</small></p>
                                    </div>
                                </div>
                                <div className="col-md-8">
                                    <div className="mt-4">
                                        <img src="https://assets.prod.abebookscdn.com/cdn/shared/images/Shared/icons/cc-visa.png" alt="" className="mr-2"/>
                                        <img src="https://assets.prod.abebookscdn.com/cdn/shared/images/Shared/icons/cc-masterc.png" alt="" className="mr-2"/>
                                        <img src="https://assets.prod.abebookscdn.com/cdn/shared/images/Shared/icons/cc-visa.png" alt="" className="mr-2"/>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="col-md-3 px-0">
                    <div className="buy-new border mt-2 rounded-top-2 mx-3">
                        ...
                        <div className="shipping d-flex flex-column small mx-2">
                            <div className="d-flex align-items-center">
                                <b>Vận chuyển</b>
                                <span className="ml-2"><i className="fas fa-shipping-fast fa-sm pr-1" style={{color: '#c0457c'}}></i>
                                    MIỄN PHÍ</span>
                            </div>
                        ...
                        <div className="add-to-basket text-center mb-4 mx-2 mt-2">
                            <a href="#" className="text-light bg-danger rounded-2 d-block mx-auto text-decoration-none py-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    className="bi bi-cart4 mr-1 pb-1" viewBox="0 0 16 16">
                                    <path
                    ...
                    <div className="text-center mt-3 mx-3"><a href="" className="text-decoration-none">Chính sách đổi trả trong 30 ngày</a></div>
                </div>
            </div>
        </div>
        )
