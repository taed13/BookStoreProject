        ...
        <div className="row">
          <div className="col-md-9 align-self-start small px-0">
            ...
            <div className="border-bottom pb-2">
              <h5 className="fw-bold mb-0">{BookDetail.name}</h5>
              ...
              <div className="border-top mt-5">
                <div className="row">
                  ...
                  <div className="col-md-8">
                    <div className="mt-4">
                      <h5 className="font-weight-bold">{BookDetail.name}</h5>
                      <p>Tác giả: {BookDetail.authorName}</p>
                      <p>Mô tả về sách... {BookDetail.description}</p>
                      <p>Thể loại: {BookDetail.productTypeName}</p>
                      <p>Ngày xuất bản: {BookDetail.publishedDate}</p>
                      <p>Nhà xuất bản: {BookDetail.publisherName}</p>
                      <p>Đánh giá: 4.5</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="buy-new border mt-2 rounded-top-2 mx-3">
              ...
              <div className="pricing d-flex flex-column mt-2 mx-2">
                <span className="text-danger fw-bolder">
                  <h4 className="mb-0">{BookDetail.price}VND</h4>
                </span>
              </div>
