...
const ForgotPassword = () => {
  ...
  const handleSubmit = (values) => {
    ...
    axios
      .post(`/users/forgotPassword/${values.email}`)
      .then((response) => {
        notification.success({
          message: "Success",
          description: "Password assistance email has been sent.",
        });
      })
      .catch((error) => {
        notification.error({
      ...
      <div className="row">
        ...
        <div className="col-sm-6 text-black">
          ...
          <div className="d-flex align-items-center justify-content-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
            <Form style={{ width: "25rem" }} onFinish={handleSubmit}>
              <h3
              ...
              <p
                ...
                style={{ letterSpacing: "1px" }}
              >
                Nhập địa chỉ email được liên kết với tài khoản Sách Việt, và
                nhấn tiếp tục.
              </p>
              <Form.Item
                name="email"
              ...
              <div className="pt-1 mb-4">
                <Button
                  type="primary"
                  htmlType="submit"
                  className="btn btn-info btn-lg btn-block bg-danger btn-danger h-100"
                >
                  Continue
                </Button>
              </div>
