				...
				<div className="col-sm-6 text-black">
					...
					<div className="d-flex align-items-center justify-content-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
						...
						<form style={ { width: '25rem' } }>
							...
							<div className="form-outline mb-4"><label for="inputCaptcha">Captcha</label>
								<div className="g-recaptcha" data-sitekey="6Lf-F_MlAAAAAGtRAebLFIZOmWWy4AyaOZUImk6P"></div>
