...
const Register = () => {
	...
	const [formData, setFormData] = useState({
	  ...
	  const handleSubmit = (e) => {
		...
		// TODO: Gửi dữ liệu đăng ký tài khoản đến server hoặc xử lý dữ liệu ở đây
				...
				<div className="col-sm-6 text-black">
					...
					<div
						...
						<form className="form-register">
							...
							<h3 className="fw-normal mb-3 pb-3 fw-bolder" style={ { letterSpacing: '1px', textAlign: 'left' } }>Sign up</h3>
							<div className="row">
