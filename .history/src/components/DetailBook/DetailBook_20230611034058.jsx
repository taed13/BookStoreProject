              ...
              <div className='row'>
                ...
                <div className='col-md-8'>
                  <div className='mt-4'>
                    ...
                    <p>Tác giả: {data?.authorName}</p>
                    <p>
                      Mô tả về sách... {data?.description}
                    </p>
                    <p>Thể loại: {data?.productTypeName}</p>
                    <p>
                      Ngày xuất bản: {data?.publishedDate}
                    </p>
                    <p>
          ...
          <div className='buy-new border mt-2 rounded-top-2 mx-3'>
            ...
            <div className='pricing d-flex flex-column mt-2 mx-2'>
              <span className='text-danger fw-bolder'>
                <h4 className='mb-0'>{data?.price}VND</h4>
              </span>
            </div>
