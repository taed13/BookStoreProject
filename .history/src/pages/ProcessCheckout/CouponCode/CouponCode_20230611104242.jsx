...
function CouponCode(props) {
  ...
  const handleApplyCoupon = (e) => {
    const currentCode =
      localStorage.getItem("current_code");
    ...
    if (!couponCodeInput) {
      ...
      if (currentCode !== couponCodeInput) {
        ...
        toast.error("Mã giống với mã cũ bạn vừa nhập !!!");
        console.log("Giong", currentCode, couponCodeInput);
      }
      // Perform the coupon code validation logic here
      console.log(data_db);
    }
    console.log("code", couponCodeInput);
