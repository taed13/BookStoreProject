          ...
          <Routes>
            ...
            >
              <Route path='detail'>
                ...
                />
                <Route
                  path='infor-my-account'
                  element={<InformationMyAccount />}
                />
                <Route
                  path='infor-my-bank-card'
                  element={<Billing />}
                />

                <Route
                  path='my-purchases'
                  element={<ViewMyPurchases />}
                />
                <Route
                  path='my-address'
                  element={<ViewMyAddress />}
                />
              </Route>
            </Route>
            <Route
            ...
            >
              <Route path='detail'>
                <Route path='my-purchases'>
                  <Route
                    path='detail-my-purchase/:id'
                    element={<DetailMyPurchase />}
                  />
                </Route>
              </Route>
            </Route>
